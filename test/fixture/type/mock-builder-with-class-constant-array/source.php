...
$builder = Eloquent\Phony\mockBuilder([Iterator::class, Serializable::class]);
$get = $builder->get();
acceptIterator($get);
...
$builder = Eloquent\Phony\Kahlan\mockBuilder([Iterator::class, Serializable::class]);
$get = $builder->get();
acceptIterator($get);
acceptSerializable($get);
acceptMock($get);
...
$builder = Eloquent\Phony\Phpunit\mockBuilder([Iterator::class, Serializable::class]);
$get = $builder->get();
acceptIterator($get);
acceptSerializable($get);
acceptMock($get);
